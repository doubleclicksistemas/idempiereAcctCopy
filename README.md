# iDempiere Acct Plugin

## Standard

- New callout
    * Name: CName
    * Package: com.dcsla.acct.callout
    * Example: com.dcsla.acct.callout.CStringFormat

- New process
    * Name: PName
    * Package: com.dcsla.acct.process
    * Example: com.dcsla.acct.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: com.dcsla.acct.form
    * Example: com.dcsla.acct.form.FMultiPayment

- New event
    * Name: EName
    * Package: com.dcsla.acct.event
    * Example: com.dcsla.acct.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: com.dcsla.acct.model
    * Example: com.dcsla.acct.model.MTableExample
...
- New callout
    * Create callout in package `com.dcsla.acct.callout`, extends from `CustomCallout`
    * Register callout in `com.dcsla.acct.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `com.dcsla.acct.process`, extends from `CustomProcess`
    * Register process in `com.dcsla.acct.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `com.dcsla.acct.form`, extends from `CustomForm`
    * Register form in `com.dcsla.acct.component.FormFactory`. Example:
...
- New event
    * Create event in package `com.dcsla.acct.event`, extends from `CustomEvent`
    * Register event in `com.dcsla.acct.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `com.dcsla.acct.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `com.dcsla.acct.component.ModelFactory`. Example:
